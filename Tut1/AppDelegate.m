...
- (void)applicationWillResignActive:(UIApplication *)application {
    ...
    [[NSUserDefaults standardUserDefaults] setObject:[NSKeyedArchiver archivedDataWithRootObject:alarmData] forKey:@"alarms"];
    [[NSUserDefaults standardUserDefaults] synchronize]; */ //CRASHES THE APP
}
